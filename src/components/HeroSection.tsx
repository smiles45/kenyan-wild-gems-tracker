  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative container mx-auto px-4 pt-24 pb-32 h-[70vh] flex flex-col items-center justify-center text-center z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 flex flex-col items-center">
            <div className="p-2 bg-forest-500 rounded-full mb-2">
              <Tent className="h-6 w-6 text-white" />
            </div>
            <h3 className="text-white font-medium">Camping Sites</h3>
          </div>
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 flex flex-col items-center">
            <div className="p-2 bg-safari-500 rounded-full mb-2">
              <Gem className="h-6 w-6 text-white" />
            </div>
            <h3 className="text-white font-medium">Hidden Gems</h3>
          </div>
          <div className="bg-white/20 backdrop-blur-sm rounded-lg p-4 flex flex-col items-center">
            <div className="p-2 bg-kenya-red rounded-full mb-2">
      ...
      <div className="absolute bottom-0 transform translate-y-1/2 w-full flex justify-center">
        <div className="bg-kenya-red w-28 h-8 rounded-full"></div>
      </div>
    </div>
  );
};
