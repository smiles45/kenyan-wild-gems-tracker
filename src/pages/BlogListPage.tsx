  ...
  return (
    <div className="max-w-2xl mx-auto py-8">
      ...
      <div className="mb-6 text-right">
        <Link to="/blog/new" className="inline-block px-4 py-2 bg-safari-600 hover:bg-safari-700 text-white rounded-md font-medium transition-colors">Write a Blog</Link>
      </div>
      {isLoading && (
